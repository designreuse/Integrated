...
<body>
    ...
    <div id="wrapper">
        ...
        <jsp:include page="${weppage}" flush="true" />
    ...
    <script src="${pageContext.request.contextPath}/assets/admintheme/js/inspinia.js"></script>
    <script src="${pageContext.request.contextPath}/assets/admintheme/js/plugins/pace/pace.min.js"></script>


</body>


<!-- Mirrored from webapplayers.com/inspinia_admin-v1.9.2/empty_page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2015 10:16:57 GMT -->
</html>
